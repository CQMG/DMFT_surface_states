        ...
        for line in f:
            ...
            if len(parts) >= 6:
                try:
                    ...
                    band_count = int(parts[4])  # The 5th number is the band count
...
df_DMFT, num_of_DMFT_bands, min_DMFT_band = parse_self_energy_file("eigvals.dat_-20to20")
...
# Example usage
file_path = 'FeTe.energy'  # Replace with the actual file path
...
print(df_DFT_relates_to_DMFT.columns)
...
output_path = 'FeTe_modified.energy'
